...
<form method="POST" action="?/signin" class="space-y-4" onsubmit={() => (submitting = true)}>
  <div class="space-y-1">
  ...
  <Button type="submit" class="w-full relative" disabled={submitting} aria-busy={submitting}>
    ...
    {/if}
    <span class:opacity-0={submitting} class="transition-opacity">Log in</span>
  </Button>

  <p class="text-center text-sm text-gray-600">
    New here? <a class="underline" href="/auth/register{page.url.search}">Create an account</a>
  </p>
</form>
