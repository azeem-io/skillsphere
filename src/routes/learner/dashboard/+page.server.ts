...
export const load = async ({ locals, url }) => {
  ...
  // mentor application status (latest one)
  ...
  // upcoming (pending/confirmed in future)
  ...
  // recent history (latest 5 finished)
  ...
  // attach feedback + ai notes for recent sessions
